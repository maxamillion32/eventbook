 ...
 */
public class EventUploadCoverRequest extends GaeRequest<UploadUrlModel> {

    private final String accessToken;
    private final String eventId;
    private final File imageFile;

    public EventUploadCoverRequest(CallChannel parent, View view, String accessToken, String eventId, File imageFile) {
        super(parent, view);
    ...
    protected Call<UploadUrlModel> getCall() {
        return GaeServer.api.getEventCoverUploadUrl(accessToken, eventId);
    }
